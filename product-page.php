							...
							<div class="product-btns">
								<form action="cartUpdate.php" method="get">
									...
									<div class="pull-right">
										<input type="button" class="main-btn icon-btn"><i class="fa fa-heart"></i></button>
										<input type="button" class="main-btn icon-btn"><i class="fa fa-exchange"></i></button>
										<input type="button" class="main-btn icon-btn"><i class="fa fa-share-alt"></i></button>
									</div>
								</form>
							</div>
						</div>
